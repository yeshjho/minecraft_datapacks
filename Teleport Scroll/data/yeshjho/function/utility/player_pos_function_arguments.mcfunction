...
execute as @s store result storage yeshjho:teleport_scroll_function_arguments player_pos_x_int int 1 run data get entity @s Pos[0]
execute as @s store result storage yeshjho:teleport_scroll_function_arguments player_pos_y_int int 1 run data get entity @s Pos[1]
execute as @s store result storage yeshjho:teleport_scroll_function_arguments player_pos_z_int int 1 run data get entity @s Pos[2]