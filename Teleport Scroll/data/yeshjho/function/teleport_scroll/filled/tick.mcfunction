...
execute as @s if score @s used_teleport_scroll_last_tick matches 1 unless data entity @s SelectedItem.components."minecraft:custom_data".interdimension run function yeshjho:teleport_scroll/filled/dimension_checker with storage yeshjho:teleport_scroll_function_arguments
