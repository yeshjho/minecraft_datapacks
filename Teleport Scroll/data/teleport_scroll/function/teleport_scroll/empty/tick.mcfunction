execute as @s run function teleport_scroll:teleport_scroll/empty/setup
...
execute as @s if score @s used_teleport_scroll_last_tick matches 1 unless score @s just_used_teleport_scroll matches 1 run function teleport_scroll:teleport_scroll/position_checker with storage teleport_scroll:function_arguments
