...
execute as @s if data entity @s SelectedItem.components."minecraft:custom_data".interdimension run function yeshjho:teleport_scroll/empty/setup_interdimension
execute as @s unless data entity @s SelectedItem.components."minecraft:custom_data".interdimension run function yeshjho:teleport_scroll/empty/setup_non_interdimension